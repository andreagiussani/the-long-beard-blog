...
Here i will just report the most important insights from the analysis. You can however check the source code to better understand the corresponding code source here.
...
The following table shows the tail of the distribution of the most popular platforms during the last 40 years, obtained by following the above steps.
...
A natural question is: which was the most popular game in each Year? To answer to this, we can employ the code below
...
As a last curiosity, we might ask: which was the most sold Title by Platform?
Using simple data manipulation, we get the following result:
...
Surprisingly none of the super marios is mentione din this list! To conclude, which are the most sold videogames ever?
